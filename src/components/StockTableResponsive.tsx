...
import { BREAKPOINT } from "../responsive/deviceType";
...
export const StockTableResponsive: FunctionComponent<Props> = props => {
  const [breakpoint, setBreakpoint] = useState(BREAKPOINT.SMALL);

  // TODO: implement watcher that reacts to screen dimension change
